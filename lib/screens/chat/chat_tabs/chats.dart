                ...
                if (snapshot.hasData && snapshot.connectionState == ConnectionState.active) {
                  ...
                  return data.isNotEmpty
                    ...
                    itemBuilder: (context, index) {
                      var message = data[index].data() as Map<String, dynamic>;
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Card(
                                  color: isCurrentUser ? MyColor.primary : MyColor.white,
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      message['message'] as String? ?? 'No message content',
                                      style: TextStyle(
                                        color: isCurrentUser ? MyColor.white : MyColor.black,
                                      ),
                                    ),
                                  ),
                                ),
                              ...
                              if (isCurrentUser)
                                FutureBuilder<String>(
                                  future: _fetchUserName(auth.currentUser!.uid),
                                  builder: (context, snapshot) {
                                    if (snapshot.connectionState == ConnectionState.done) {
                                      return RandomAvatar(
                                        snapshot.data!,
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.send, color: MyColor.primary),
                  onPressed: () {
